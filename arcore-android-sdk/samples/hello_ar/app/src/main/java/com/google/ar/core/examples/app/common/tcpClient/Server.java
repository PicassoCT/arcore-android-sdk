    ...
    public class DatagramReciever extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                senderSocket = setSocketAddress(null, ARDeviceAddress,SpringAR.UDP_SERVER_PORT);
            ...
            switch (State) {
                ...
                case STATE_broadCastHeader: {
                    if (comonUtils.indexOf(payload[writeBuffer], SpringAR.recieveHostReplyHeaderByte) != -1) {
                        ...
                        senderSocket = setSocketAddress(senderSocket, ARDeviceAddress, SpringAR.UDP_SERVER_PORT);
